...
LTTNG_UST_TRACEPOINT_ENUM(cds_ft, ft_tp_node_kind,
	LTTNG_UST_TP_ENUM_VALUES(
		...
		lttng_ust_field_enum_value("BP1L_256",		FT_TP_NODE_BP1L_256)
		lttng_ust_field_enum_value("BP1L_512",		FT_TP_NODE_BP1L_512)
		lttng_ust_field_enum_value("BP1L_1024",		FT_TP_NODE_BP1L_1024)
