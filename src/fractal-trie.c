...
{
	/*
	 * The historical pools at indices 5 and 6 are byte_popcount_1l
	 * layouts in the FT_POPCOUNT class (no subnodes), so FT_POOL is
	 * empty and the bit-selector / 2D-index machinery is unused.
	 */
